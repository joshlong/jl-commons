...
public class FileUtilsTest {
   ...
   /* @Test
    public void testCopyFile() throws Throwable {
        final File a = this.context.mock(File.class, "a"), b = this.context.mock(File.class, "b");
        this.context.checking(new Expectations() {{
...
*/
    ...
    @Test
    public void testEnsureDirectoryExistsInNegativeCase() throws Throwable {
        final File f = this.context.mock(File.class);
    ...
    @Test
    public void testEnsureDirectoryExistsInNegativeCaseAndFileIsFile() throws Throwable {
        final File f = this.context.mock(File.class);
        final File fParent = this.context.mock(File.class, "parent");
        this.context.checking(new Expectations() {
            {
